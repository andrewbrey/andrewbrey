    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center h-full p-4">
        ...
        <div className="relative">
          ...
          <h2 className="mt-2 text-2xl text-center md:mt-3 md:text-3xl text-smoke-300 select-none">
            Software Developer
          </h2>
          <div className="grid grid-cols-2 gap-4 mt-12 sm:grid-cols-3 md:grid-cols-4">
            {links.map((l) => (
              <Link
                key={l.text}
                href={l.link}
                className="px-3 py-1.5 rounded-full ring-2 ring-smoke-100 uppercase text-sm text-center whitespace-nowrap truncate text-smoke-100 bg-smoke-200 bg-opacity-10 hover:bg-opacity-30 focus-within:bg-opacity-30 focus-within:outline-none focus-within:ring-offset-2 select-none"
              >
                {l.text}
              </Link>
            ))}
